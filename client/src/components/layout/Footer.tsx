    ...
    <footer className="bg-deep-blue text-white pt-20 pb-10">
      <div className="container mx-auto px-4">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <span className="font-serif text-2xl font-bold tracking-widest">OCEANJETSKI</span>
          ...
          <div>
            ...
            <ul className="space-y-6">
              ...
              <li className="flex items-center gap-4">
                ...
                <span className="text-white/70">reservas@oceanjetski.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-white/40">
          <p>© 2025 OCEANJETSKI. Todos los derechos reservados.</p>
